...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url() . 'assets/css/AdminRequestPage.css' ?>">
</head>
...
<div id="approvePopup" class="custom-div">
    ...
    <script>
        ...
        let currentPage = 1;
        const vendorData = [
            { name: "John Doe", email: "JohnDoe@gmail.com", address: "MG Road, Nashik 422001", experience: "5 yrs", phone: "1234567890", specification: "Commercial Carpentry Services", documents: "View Documents", status: "Approved" },
            { name: "Jane Doe", email: "JaneDoe@gmail.com", address: "MG Road, Nashik 422001", experience: "3 yrs", phone: "1234567891", specification: "Electrical Services", documents: "View Documents", status: "Pending" },
            { name: "Mark Smith", email: "MarkSmith@gmail.com", address: "MG Road, Nashik 422001", experience: "4 yrs", phone: "1234567892", specification: "Plumbing Services", documents: "View Documents", status: "Rejected" },
            { name: "Sara Lee", email: "SaraLee@gmail.com", address: "MG Road, Nashik 422001", experience: "2 yrs", phone: "1234567893", specification: "Painting Services", documents: "View Documents", status: "Approved" },
            { name: "Paul Brown", email: "PaulBrown@gmail.com", address: "MG Road, Nashik 422001", experience: "6 yrs", phone: "1234567894", specification: "HVAC Services", documents: "View Documents", status: "Rejected" },
            { name: "Lisa Ray", email: "LisaRay@gmail.com", address: "MG Road, Nashik 422001", experience: "5 yrs", phone: "1234567895", specification: "Flooring Services", documents: "View Documents", status: "Pending" },
            { name: "Tom Hardy", email: "TomHardy@gmail.com", address: "MG Road, Nashik 422001", experience: "7 yrs", phone: "1234567896", specification: "Commercial Carpentry Services", documents: "View Documents", status: "Approved" },
            { name: "Emily White", email: "EmilyWhite@gmail.com", address: "MG Road, Nashik 422001", experience: "3 yrs", phone: "1234567897", specification: "Electrical Services", documents: "View Documents", status: "Pending" },
            { name: "Luke Wilson", email: "LukeWilson@gmail.com", address: "MG Road, Nashik 422001", experience: "4 yrs", phone: "1234567898", specification: "Plumbing Services", documents: "View Documents", status: "Rejected" },
            { name: "Luke Wilson", email: "LukeWilson@gmail.com", address: "MG Road, Nashik 422001", experience: "4 yrs", phone: "1234567898", specification: "Plumbing Services", documents: "View Documents", status: "Rejected" },
            { name: "Luke Wilson", email: "LukeWilson@gmail.com", address: "MG Road, Nashik 422001", experience: "4 yrs", phone: "1234567898", specification: "Plumbing Services", documents: "View Documents", status: "Rejected" },
            { name: "Luke Wilson", email: "LukeWilson@gmail.com", address: "MG Road, Nashik 422001", experience: "4 yrs", phone: "1234567898", specification: "Plumbing Services", documents: "View Documents", status: "Rejected" },
            { name: "Luke Wilson", email: "LukeWilson@gmail.com", address: "MG Road, Nashik 422001", experience: "4 yrs", phone: "1234567898", specification: "Plumbing Services", documents: "View Documents", status: "Rejected" },
            ...
            { name: "Luke Wilson", email: "LukeWilson@gmail.com", address: "MG Road, Nashik 422001", experience: "4 yrs", phone: "1234567898", specification: "Plumbing Services", documents: "View Documents", status: "Rejected" },
            { name: "Luke Wilson", email: "LukeWilson@gmail.com", address: "MG Road, Nashik 422001", experience: "4 yrs", phone: "1234567898", specification: "Plumbing Services", documents: "View Documents", status: "Rejected" },
            { name: "Sophia Green", email: "SophiaGreen@gmail.com", address: "MG Road, Nashik 422001", experience: "2 yrs", phone: "1234567899", specification: "Painting Services", documents: "View Documents", status: "Approved" }
        ];
        ...
        function renderTable() {
            ...
            const rows = filteredData.slice(start, end).map(data => `
                <tr>
                    ...
                    <td><a href="#" class="text-decoration-none">${data.documents}</a></td>
                 
                    <td style="display:flex; gap:4px;">
                        <button class="btn btn-success btn-sm" style="border-radius: 50%;">&#10003;</button>
