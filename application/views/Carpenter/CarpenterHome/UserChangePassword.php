...
<head>
    ...
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet"
        ...
        <link rel="stylesheet" href="<?php echo base_url() . 'assets/css/UserChangePassword.css' ?>">
...
<body>
    ...
    <div class="side-space">
        ...
        <div class="nav-links m-0" style="border-radius: 8px 8px 0px 0px;">
                <a href="<?php echo base_url() . 'CarpenterUserSide/profile' ?>" >Account Info</a>
                <a href="<?php echo base_url() . 'CarpenterUserSide/changePassword' ?>" class="active">Privacy & Security</a>
                <a href="#">Logout</a>
            </div>
            <div style="padding: 30px;">
                <form id="myForm">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="password" class="form-control-lg" id="password" placeholder="Enter New Password"
                            required>
                    </div>
                    <div class="mb-3">
