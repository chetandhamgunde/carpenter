...
<head>
    ...
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet"
        ...
        <link rel="stylesheet" href="<?php echo base_url() . 'assets/css/VendorChangePassword.css' ?>">
</head>
...
<body>
    ...
    <div class="side-space">
        ...
        <div class="nav-links m-0" style="border-radius: 8px 8px 0px 0px;">
                <a href="<?php echo base_url() . 'CarpenterVendorSide/profile' ?>">Account Info</a>
                <a href="<?php echo base_url() . 'CarpenterVendorSide/changePassword' ?>" class="active">Privacy & Security</a>
                <a href="#">Logout</a>
            </div>
